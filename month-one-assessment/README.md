...
![](https://github.com/lolabol/month-one-assessment/blob/main/month-one-assessment/evidence/postgres-db-status.png?raw=true)
...
other screenshots are in the evidence folder.

Prepared by: Omolola Eyanuku (ALT/SOE/025/5119) for Techcorp
